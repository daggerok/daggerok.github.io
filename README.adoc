= my-blog.now.sh image:https://github.com/daggerok/daggerok.github.io/actions/workflows/github-pages.yaml/badge.svg["Build Status", link="https://github.com/daggerok/daggerok.github.io/actions/workflows/github-pages.yaml"]
...
[source,bash]
----
npm i ; npx yarn install ; npm run build
